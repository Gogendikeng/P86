var grades = [];
        var update_scores = function () {
           ...
           document.getElementById("scores, student_name").value = val;
           document.getElementById("scores, student_name").value = "";   
           document.getElementById("scores, student_name").focus();
        }    
